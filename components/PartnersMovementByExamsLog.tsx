...
import type { PartnersDataByExams } from '../types';

interface PartnersMovementByExamsLogProps {
    data: PartnersDataByExams;
...
const PartnersMovementByExamsLog: React.FC<PartnersMovementByExamsLogProps> = ({ data, onDelete }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex justify-between items-center cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                <h2 className="text-xl font-bold text-gray-800">Histórico de Movimentação de Parceiros (por número de exames)</h2>
...
export default PartnersMovementByExamsLog;
